...
e.preventDefault()
  ...
  return (
    <div className="d-flex justify-center align-items-center h-screen">
      ...
      <Form className="w-1/2 border border-3 p-4 rounded">
     <InputGroup className="mb-3 h-14">
            <InputGroup.Text id='basicaddon1'>
            Name :
            </InputGroup.Text>
            <Form.Control disabled={ndisable} onChange={(e)=>{setname(e.target.value)}} value={name}/>
  ...
  <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001z"/>
     ...
     <InputGroup className="mb-3 h-14">
            ...
            <Form.Control disabled={edisable} onChange={(e)=>{setemail(e.target.value)}} value={email}/>
  ...
  <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001z"/>
     ...
     <InputGroup className="mb-3 h-14">
            ...
            <Form.Control disabled={pdisable} onChange={(e)=>{setphone(e.target.value)}} value={phone}/>
